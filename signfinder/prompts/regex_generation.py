...
ВАЖНО по количеству: верни НЕ БОЛЕЕ 15 паттернов — только наиболее характерные
для ЭТОГО конкретного документа. Не генерируй декартово произведение всех
вариантов подчёркиваний × все маркеры. Предпочти 1-2 точных паттерна 10 похожим.
